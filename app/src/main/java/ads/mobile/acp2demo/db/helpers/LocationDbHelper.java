...
import ads.mobile.acp2demo.db.tables.LocationTable;
import ads.mobile.acp2demo.db.tables.LocationTable.LocationEntry;
...
public class LocationDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + LocationEntry.TABLE_NAME + " (" +
                    ...
                    LocationEntry.COLUMN_NAME_UUID + " TEXT," +
                    LocationEntry.COLUMN_NAME_TIMESTAMP + " TEXT," +
                    LocationEntry.COLUMN_NAME_ELEMENT + " TEXT," +
    ...
    public void insertEntity (String uuid, String timestamp,
        ...
        contentValues.put(LocationEntry.COLUMN_NAME_UUID, uuid);
        contentValues.put(LocationEntry.COLUMN_NAME_TIMESTAMP, timestamp);
        contentValues.put(LocationEntry.COLUMN_NAME_ELEMENT, element);
